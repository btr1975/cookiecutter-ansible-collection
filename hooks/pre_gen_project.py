...
if __name__ == "__main__":
    ...
    validate_no_spaces(
        arg_name="{{ cookiecutter.git_username_or_organization }}",
        human_readable_name="git_username_or_organization",
    )  # pragma: no cover

    validate_no_spaces(
        arg_name="{{ cookiecutter.collection_namespace }}",
        human_readable_name="collection_namespace",
    )  # pragma: no cover
    validate_no_spaces(
        arg_name="{{ cookiecutter.collection_name }}",
        human_readable_name="collection_name",
    )  # pragma: no cover
    validate_semantic_version(
        arg_name="{{ cookiecutter.collection_version }}",
        human_readable_name="collection_version",
    )  # pragma: no cover
    validate_no_spaces_begin_or_end(
        arg_name="{{ cookiecutter.collection_description }}",
        human_readable_name="collection_description",
    )  # pragma: no cover
